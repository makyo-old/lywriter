...
/**
 * Write a choir staff group's Lilypond data
 *
 * @see com.mjs_svc.lywriter.plugins.lilypond.output.StaffGroupWriter
 * @author Matthew Scott
 * @version $Id: ChoirStaffWriter.java 4 2010-02-02 23:14:49Z mjs@mjs-svc.com $
 */
public class ChoirStaffWriter extends MusicWriter implements ScoreContext {

    /**
     *
     * @param m
     */
    public ChoirStaffWriter(MusicObject _obj) {
        super(_obj);
